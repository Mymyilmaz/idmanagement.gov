...
<ol class="usa-process-list">
  ...
  <h4 class="usa-process-list__heading">Read and follow Approval Procedures</h4>
  ...
  <li class="usa-process-list__item">
  <h4 class="usa-process-list__heading">Complete Application Form</h4>
    <p>
  ...
  <li class="usa-process-list__item">
  <h4 class="usa-process-list__heading">Complete Attestations Form</h4>
    <p>
