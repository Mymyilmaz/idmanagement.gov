...
<div class="usa-alert usa-alert--info">
  <div class="usa-alert__body">
    ...
    <p class="usa-alert__text">If you are a <i>Vendor or Supplier</i> looking for the <strong>PIV Card APL Evaluation Program Application Form</strong> required for submission of your product, please use the button below to access this form.</p>
    <br/>
